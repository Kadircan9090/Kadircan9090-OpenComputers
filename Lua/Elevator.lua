--[[ Funky Locomotion Elevator
     Created for the Youtube channel https://www.youtube.com/@KadircanSahin34 2023
...
local sideup = sides.west     -- side of redstone block/card for sending up
local sidedown = sides.east    -- side of redstone block/card for sending down
local sidedisplay = sides.top  -- side the segment display is on
local sidedoors = sides.bottom -- side that triggers the doors

local rsio_reader = "078e08fd-b26c-4ff4-9e12-9e470cc87e59"   -- the address of the redstone io for reading
local rsio reader = "9e7147c5-63f3-4cd4-ab86-d0418593cad2"
...
local floormax = 4             -- the number of floors (for the GUI) - max 16 colors
-- end settings
